...
public class BirthDayReminder {
	...
	public static void main(String[] args) {
		...
		String writableData = "";
		String bDayFileName = "C:/Users/user/Desktop/Prakash/MyPersonal/BirthDayReminder.txt";
		String amountFileName = "C:/Users/user/Desktop/Prakash/MyPersonal/AmountReminder.txt";
		...
		try {
			...
			if(runType != null && runType.trim().equalsIgnoreCase("write")){
				...
				String[] twoDates = new BirthDayReminder().getTwoDates();
